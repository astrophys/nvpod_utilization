...
def parse_sacct_file(path : str = None):
    ...
    ## Added for purpose of unit-testing using data generated by make_fake_data.py
    totalgpuraw = 0
    totalcpuraw = 0
    for job in jobL:
        totalgpuraw += job.gputimeraw
        totalcpuraw += job.cputimeraw
    return(totalgpuraw, totalcpuraw, jobL, starttime, endtime)
